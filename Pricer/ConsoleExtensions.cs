...
public static class ConsoleEx
{
   private static readonly Regex HoursRegex = new(
	...
	private static bool TryParseHours(string inputRaw, out decimal hours)
	{
        ...
        // 1:10 or 01:10 (HH:mm) OR 15:35 (mm:ss) OR 1:10:05 (HH:mm:ss)
		...
		if (colonIndex >= 0)
		{
           ...
           switch (parts.Length)
			{
				case 2:
					// Ambiguous, but for print times it's safer to treat small first component as minutes.
					// If the first part is >= 60, treat as hours.
